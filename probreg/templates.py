"""Probreg: templates for neatly displaying the text of a registration

currently only used in ppg version
"""
...
def test_printno():
    data = {"id": "nummer",
            ...
            "elijst": [("moment 1", "eerst gebeurde er dit"),
...
def test_printall():
    data = {"id": "nummer",
            ...
            "events": [("moment 1", "eerst gebeurde er dit"),
                       ("moment 2", "en later iets anders")]}
    tabs = ["tab 0", "tab 1", "tab 2", "tab 3", "tab 4", "tab 5", "tab 6"]
    cats = {0: ("cat0", 0),
            1: ("cat1", 1),
